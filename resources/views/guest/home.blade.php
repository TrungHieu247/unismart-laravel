                ...
                <div class="section-detail">
                    <ul class="list-item">
                        ...
                        <li>
                            ...
                            <a style="height: 30px" href="{{ route('product.detail', $item->id) }}" title=""
                            ...
                            <div class="action clearfix">
                                <a href="{{ route('cart.add', $item->id) }}" title="" class="add-cart fl-left">Thêm giỏ
                                    hàng</a>
                                <a href="{{ route('product.detail', $item->id) }}" title="" class="buy-now fl-right">Mua
                                    ngay</a>
                            </div>
                        </li>
                        @endif
                    ...
                    <ul class="list-item clearfix">
                        ...
                        <li>
                            ...
                            <div class="action clearfix">
                                ...
                                <a href="{{ route('product.detail',$item->id) }}" title="Mua ngay"
